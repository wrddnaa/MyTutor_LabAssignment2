...
class _LoginScreenState extends State<LoginScreen> {
                          ...
                          TextButton(
                            onPressed: () {
                              ...
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      const RegisterScreen(title: 'Registration Page',),
                                ), 
                              );
                            },
                            child: const Text('Create an account to register'),
                          ),
                        ],
                      ),
                  ),
  ...
  void _loginUser() {
    ...
    if (_formKey.currentState!.validate()) {
      _formKey.currentState!.save();
      http.post(
          Uri.parse(CONSTANTS.server + "/my_tutor/member/php/login_user.php"),
